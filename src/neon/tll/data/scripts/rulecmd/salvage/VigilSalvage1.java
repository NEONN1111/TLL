package neon.tll.data.scripts.rulecmd.salvage;
...
public class VigilSalvage1 extends BaseCommandPlugin {
	...
	protected PlanetAPI tll_habplanet;
	...
	protected void init(SectorEntityToken entity) {
		...
		this.entity = entity;
		tll_habplanet = (PlanetAPI) entity;
	...
	protected void genLoot() {
		...
		MemoryAPI memory = tll_habplanet.getMemoryWithoutUpdate();
		...
		CargoAPI salvage = SalvageEntity.generateSalvage(random, 1f, 1f, 1f, 1f, tll_habplanet.getDropValue(), tll_habplanet.getDropRandom());
