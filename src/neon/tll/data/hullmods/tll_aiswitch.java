...
import static neon.tll.data.tll_reference_sheet.tll_AISWITCHAUTOMATED;
import static neon.tll.data.tll_reference_sheet.tll_AISWITCHMANUAL;

public class tll_aiswitch extends BaseHullMod {

    private final String switchTag = "tll_switched";
    ...
    public void applyEffectsBeforeShipCreation(
        ...
        if (ship.getHullSpec().hasTag("tll_aiswitch")) {
            float crew;
    ...
    private void handleAutomationSwitching(ShipVariantAPI variantStats) {
        if (variantStats.hasTag(Tags.AUTOMATED)) {
            if (!variantStats.hasHullMod(tll_AISWITCHAUTOMATED)) {
                variantStats.removeTag(Tags.AUTOMATED);
                variantStats.addMod(tll_AISWITCHMANUAL);
            ...
            if (!variantStats.hasHullMod(tll_AISWITCHMANUAL)) {
                variantStats.addTag(Tags.AUTOMATED);
                variantStats.addMod(tll_AISWITCHAUTOMATED);
